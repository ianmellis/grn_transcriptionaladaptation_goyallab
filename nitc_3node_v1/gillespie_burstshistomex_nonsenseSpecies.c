...
if (p<cumpropensities[0]) {
  ...
  propensities[8] = onbasal_a1 *Burst1_off_orig;
  ...
  propensities[10] = B_ondep1 *(pow(A1,nA1 )/(pow(kA1 ,nA1 )+pow(A1,nA1 )))*Burst1_off_targ+ B_ondep_prime *(pow(Aprime1,nAprime1 )/(pow(kAprime1 ,nAprime1 )+pow(Aprime1,nAprime1 )))*Burst1_off_targ +onbasal_b1 *Burst1_off_targ;
  //update propensity for Burst1_on_orig = Burst1_off_orig
  propensities[11] = A_off1 *Burst1_on_orig;
