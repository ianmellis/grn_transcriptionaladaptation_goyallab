...
dydt(10) = -y(10)*((r_onbasal_Aprime1 + r_nitc_byAnonsense1_Aprime1*y(6)^n_Anonsense1/(k_Anonsense1^n_Anonsense1 + y(6)^n_Anonsense1))) ...
    + r_off_Aprime1*y(9);
% y(11) = onap2_1 
dydt(11) = y(12)*(r_onbasal_Aprime1 + r_nitc_byAnonsense1_Aprime1*y(6)^n_Anonsense1/(k_Anonsense1^n_Anonsense1 + y(6)^n_Anonsense1)) ...
    - r_off_Aprime1*y(11);
% y(12) = offap2_1 
dydt(12) = -y(12)*((r_onbasal_Aprime1 + r_nitc_byAnonsense1_Aprime1*y(6)^n_Anonsense1/(k_Anonsense1^n_Anonsense1 + y(6)^n_Anonsense1))) ...
    + r_off_Aprime1*y(11);
% y(13) = onap2_2 
dydt(9) = y(14)*(r_onbasal_Aprime1 + r_nitc_byAnonsense1_Aprime1*y(6)^n_Anonsense1/(k_Anonsense1^n_Anonsense1 + y(6)^n_Anonsense1)) ...
    - r_off_Aprime1*y(13);
% y(14) = offap2_2 
dydt(10) = -y(14)*((r_onbasal_Aprime1 + r_nitc_byAnonsense1_Aprime1*y(6)^n_Anonsense1/(k_Anonsense1^n_Anonsense1 + y(6)^n_Anonsense1))) ...
    + r_off_Aprime1*y(13);
% y(15) = aprim1 
