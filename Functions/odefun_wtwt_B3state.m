...
% y(12) = onborig_1
dydt(12) = (r_onbasal_B1 + r_addon_byA1_B1*y(5)^n_A1/(k_A1^n_A1 + y(5)^n_A1))*y(14) - r_off_B1*y(12);
% y(13) = onbpara_1
dydt(13) = (r_onbasal_B1 + r_addon_byAprime1_B1*y(11)^n_Aprime1/(k_Aprime1^n_Aprime1 + y(11)^n_Aprime1))*y(14) - r_off_B1*y(13);
% y(14) = offb_1
dydt(14) = -y(14)*((r_onbasal_B1 + r_addon_byA1_B1*y(5)^n_A1/(k_A1^n_A1 + y(5)^n_A1)) + (r_onbasal_B1 + r_addon_byAprime1_B1*y(11)^n_Aprime1/(k_Aprime1^n_Aprime1 + y(11)^n_Aprime1))) ...
    + r_off_B1*y(12) + r_off_B1*y(13);
% y(15) = onborig_2
dydt(15) = (r_onbasal_B1 + r_addon_byA1_B1*y(5)^n_A1/(k_A1^n_A1 + y(5)^n_A1))*y(17) - r_off_B1*y(15);
% y(16) = onbpara_2
dydt(16) = (r_onbasal_B1 + r_addon_byAprime1_B1*y(11)^n_Aprime1/(k_Aprime1^n_Aprime1 + y(11)^n_Aprime1))*y(17) - r_off_B1*y(15);
% y(17) = offb_2
dydt(17) = -y(17)*((r_onbasal_B1 + r_addon_byA1_B1*y(5)^n_A1/(k_A1^n_A1 + y(5)^n_A1)) + (r_onbasal_B1 + r_addon_byAprime1_B1*y(11)^n_Aprime1/(k_Aprime1^n_Aprime1 + y(11)^n_Aprime1))) ...
    + r_off_B1*y(15) + r_off_B1*y(16);
% y(18) = b
dydt(18) = r_prodon_B1*y(12) + (1/d_Aprime1_B1)*r_prodon_B1*y(13) + r_prodon_B1*y(15) + (1/d_Aprime1_B1)*r_prodon_B1*y(16) - r_deg_B1*y(18);
end