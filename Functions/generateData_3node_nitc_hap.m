...
%         how to handle?
    ...
    for kmem = 1:1
        ...
        S = [repmat(A1,nruns,1),...
            ...
            repmat(B1,nruns,1),...
            repmat(Burst1_off_targ,nruns,1),...
            repmat(Burst1_on_targ,nruns,1),...
            repmat(Burst1_off_para,nruns,1),...
            repmat(Burst1_on_para,nruns,1),...
            repmat(Burst1_on_orig,nruns,1),...
            repmat(Burst1_off_orig,nruns,1),...
            repmat(Burst1_is_mutated,nruns,1),...
            repmat(Burst1_not_mutated,nruns,1)];
