...
p1<-ggplot(params_inferred, aes(x=r_on)) + geom_histogram()
p2<-ggplot(params_inferred, aes(x=log10(on_off_ratio))) + geom_histogram()
p3<-ggplot(params_inferred, aes(x=r_prod)) + geom_histogram() +scale_x_log10()
