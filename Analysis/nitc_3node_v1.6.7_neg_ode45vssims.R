...
# edit as needed
datadir <- '/Volumes/IAMYG1/grn_nitc_data/v1.6.7/samples/'
plotdir <- '~/code/grn_nitc/nitc_3node_v1.6.7/exploratory_analysis/'
setwd(datadir)
...
#wtwt ode45
setwd(plotdir)
steadystate_ode45_wtwt <- as_tibble(read.csv('../steady_state_ODE45_wtwt_B3state_neg.csv', header = T))
