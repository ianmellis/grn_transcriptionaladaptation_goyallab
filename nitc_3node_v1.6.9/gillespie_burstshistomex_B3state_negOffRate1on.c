...
//INSERT ALL VARIABLE DECLARATIONS HERE
  long A1, Anonsense1, Aprime1, B1, Burst1_on_targ_allele1, Burst1_on_targ_allele2, Burst1_on_para_allele1, Burst1_on_para_allele2, Burst1_on_orig_allele1, Burst1_on_orig_allele2, Burst1_is_mutated_allele1, Burst1_is_mutated_allele2;
...
//UNPACK ALL SPECIES HERE
  ...
  Burst1_on_targ_allele1 = (long)species[4];
  Burst1_on_targ_allele2 = (long)species[5];
  Burst1_on_para_allele1 = (long)species[6];
  Burst1_on_para_allele2 = (long)species[7];
  Burst1_on_orig_allele1 = (long)species[8];
  Burst1_on_orig_allele2 = (long)species[9];
  Burst1_is_mutated_allele1 = (long)species[10];
  Burst1_is_mutated_allele2 = (long)species[11];
...
species_out[savecount*NSPECIES+4] = Burst1_on_targ_allele1;
species_out[savecount*NSPECIES+5] = Burst1_on_targ_allele2;
species_out[savecount*NSPECIES+6] = Burst1_on_para_allele1;
species_out[savecount*NSPECIES+7] = Burst1_on_para_allele2;
species_out[savecount*NSPECIES+8] = Burst1_on_orig_allele1;
species_out[savecount*NSPECIES+9] = Burst1_on_orig_allele2;
species_out[savecount*NSPECIES+10] = Burst1_is_mutated_allele1;
species_out[savecount*NSPECIES+11] = Burst1_is_mutated_allele2;
...
if (p<cumpropensities[0]) {
  ...
  propensities[16] = (1-Burst1_on_targ_allele1)*(r_onbasal_B1);
  //update propensity for Burst1_off_targ = Burst1_on_targ for allele2
  propensities[17] = (1-Burst1_on_targ_allele2)*(r_onbasal_B1);
  ...
  propensities[22] = Burst1_on_targ_allele1*(r_offorig_B1 + r_addon_byA1_B1*(pow(A1,n_A1 )/(pow(k_A1 ,n_A1 )+pow(A1,n_A1 ))) + r_addon_byAprime1_B1*(pow(Aprime1,n_Aprime1 )/(pow(k_Aprime1 ,n_Aprime1 )+pow(Aprime1,n_Aprime1 ))));
  //update propensity for Burst1_on_targ = Burst1_off_targ for allele2
  propensities[23] = Burst1_on_targ_allele2*(r_offorig_B1 + r_addon_byA1_B1*(pow(A1,n_A1 )/(pow(k_A1 ,n_A1 )+pow(A1,n_A1 ))) + r_addon_byAprime1_B1*(pow(Aprime1,n_Aprime1 )/(pow(k_Aprime1 ,n_Aprime1 )+pow(Aprime1,n_Aprime1 ))));
