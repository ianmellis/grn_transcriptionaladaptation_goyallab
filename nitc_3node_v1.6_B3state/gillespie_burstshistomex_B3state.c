...
//UNPACK ALL SPECIES HERE
  ...
  Burst1_onorig_targ_allele1 = (long)species[4];
  Burst1_onpara_targ_allele1 = (long)species[5];
  Burst1_off_targ_allele1 = (long)species[6];
  Burst1_onorig_targ_allele2 = (long)species[7];
  Burst1_onpara_targ_allele2 = (long)species[8];
  Burst1_off_targ_allele2 = (long)species[9];
...
species_out[savecount*NSPECIES+4] = Burst1_onorig_targ_allele1;
species_out[savecount*NSPECIES+5] = Burst1_onpara_targ_allele1;
species_out[savecount*NSPECIES+6] = Burst1_off_targ_allele1;
species_out[savecount*NSPECIES+7] = Burst1_onorig_targ_allele2;
species_out[savecount*NSPECIES+8] = Burst1_onpara_targ_allele2;
species_out[savecount*NSPECIES+9] = Burst1_off_targ_allele2;
...
if (p<cumpropensities[0]) {
  ...
  propensities = updatePropensities(propensities, rates, species)
  ...
  propensities[17] = (Burst1_off_targ_allele1)*(r_onbasal_B1 + r_addon_byAprime1_B1*(pow(Aprime1,n_A1 )/(pow(k_Aprime1 ,n_Aprime1 )+pow(Aprime1,n_Aprime1 ))));
  ...
  propensities[19] = (Burst1_off_targ_allele2)*(r_onbasal_B1 + r_addon_byAprime1_B1*(pow(Aprime1,n_A1 )/(pow(k_Aprime1 ,n_Aprime1 )+pow(Aprime1,n_Aprime1 ))));
  ...
  propensities[22] = Burst1_onorig_targ_allele1*r_offorig_B1;
  //update propensity for Burst1_onpara_targ = Burst1_off_targ for allele1
  propensities[23] = Burst1_onpara_targ_allele1*r_offpara_B1;
  //update propensity for Burst1_onorig_targ = Burst1_off_targ for allele2
  propensities[24] = Burst1_onorig_targ_allele2*r_offorig_B1;
  //update propensity for Burst1_onpara_targ = Burst1_off_targ for allele2
  propensities[25] = Burst1_onpara_targ_allele2*r_offpara_B1;
  ...
  propensities[16] = (1-Burst1_on_targ_allele1)*(r_onbasal_B1*Promoter1_unbound_targ_allele1 + r_bound_byA1_B1*Promoter1_boundbyorig_targ_allele1 + r_bound_byAprime1_B1*Promoter1_boundbypara_targ_allele1);
  //update propensity for Burst1_off_targ = Burst1_on_targ for allele2
  propensities[17] = (1-Burst1_on_targ_allele2)*(r_onbasal_B1*Promoter1_unbound_targ_allele2 + r_bound_byA1_B1*Promoter1_boundbyorig_targ_allele2 + r_bound_byAprime1_B1*Promoter1_boundbypara_targ_allele2);
  ...
  // rxn: Promoter1_unbound_targ_allele2 = Promoter1_boundbypara_targ_allele2
