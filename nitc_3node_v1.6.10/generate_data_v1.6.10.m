...
trace_outdir = '/Volumes/IAMYG1/grn_nitc_data/v1.6.10/fullTraces/';
psc_outdir = '/Volumes/IAMYG1/grn_nitc_data/v1.6.10/samples/';
psc_refdir = '~/code/grn_nitc/nitc_3node_v1.6.10/refs/';
...
for ind = 1:(length(bounds)-1)
    ...
    parfor j = 1:lenbd
        ...
        d_Aprime1_B1 = 1/A1_Aprime_onrate_ratio; % multiplied in sim, so reciprocal taken here
