...
//INSERT ALL VARIABLE DECLARATIONS HERE
  long A1, Anonsense1, Aprime1, B1, Burst1_offorig_targ_allele1, Burst1_offpara_targ_allele1, Burst1_on_targ_allele1, Burst1_offorig_targ_allele2, Burst1_offpara_targ_allele2, Burst1_on_targ_allele2, Burst1_on_para_allele1, Burst1_on_para_allele2, Burst1_on_orig_allele1, Burst1_on_orig_allele2, Burst1_is_mutated_allele1, Burst1_is_mutated_allele2;
...
//UNPACK ALL SPECIES HERE
  ...
  Burst1_offorig_targ_allele1 = (long)species[4];
  Burst1_offpara_targ_allele1 = (long)species[5];
  Burst1_on_targ_allele1 = (long)species[6];
  Burst1_offorig_targ_allele2 = (long)species[7];
  Burst1_offpara_targ_allele2 = (long)species[8];
  Burst1_on_targ_allele2 = (long)species[9];
  Burst1_on_para_allele1 = (long)species[10];
  Burst1_on_para_allele2 = (long)species[11];
  Burst1_on_orig_allele1 = (long)species[12];
  Burst1_on_orig_allele2 = (long)species[13];
  Burst1_is_mutated_allele1 = (long)species[14];
  Burst1_is_mutated_allele2 = (long)species[15];
...
//UNPACK ALL RATES HERE
  ...
  r_addon_byA1_B1 = rates[20];
  r_addon_byAprime1_B1 = rates[21];

  r_off_A1 = rates[22];
  r_off_Anonsense1 = rates[23];
  r_off_Aprime1 = rates[24];
  r_offorig_B1 = rates[25];
  r_offpara_B1 = rates[26];
...
species_out[savecount*NSPECIES+4] = Burst1_offorig_targ_allele1;
species_out[savecount*NSPECIES+5] = Burst1_offpara_targ_allele1;
species_out[savecount*NSPECIES+6] = Burst1_on_targ_allele1;
species_out[savecount*NSPECIES+7] = Burst1_offorig_targ_allele2;
species_out[savecount*NSPECIES+8] = Burst1_offpara_targ_allele2;
species_out[savecount*NSPECIES+9] = Burst1_on_targ_allele2;
species_out[savecount*NSPECIES+10] = Burst1_on_para_allele1;
species_out[savecount*NSPECIES+11] = Burst1_on_para_allele2;
species_out[savecount*NSPECIES+12] = Burst1_on_orig_allele1;
species_out[savecount*NSPECIES+13] = Burst1_on_orig_allele2;
species_out[savecount*NSPECIES+14] = Burst1_is_mutated_allele1;
species_out[savecount*NSPECIES+15] = Burst1_is_mutated_allele2;
...
if (p<cumpropensities[0]) {
  ...
  propensities[7] = r_prodon_B1 *Burst1_on_targ_allele2 + r_prodbasal_B1 * (1-Burst1_on_targ_allele2);
  ...
  //update propensity for Burst1_offorig_targ = Burst1_on_targ for allele1
  propensities[16] = Burst1_offorig_targ_allele1*(r_onbasal_B1);
  //update propensity for Burst1_offpara_targ = Burst1_on_targ for allele1
  propensities[17] = Burst1_offpara_targ_allele1*(r_onbasal_B1 * d_Aprime1_B1);
  //update propensity for Burst1_offorig_targ = Burst1_on_targ for allele2
  propensities[18] = Burst1_offorig_targ_allele2*(r_onbasal_B1);
  //update propensity for Burst1_offpara_targ = Burst1_on_targ for allele2
  propensities[19] = Burst1_offpara_targ_allele2*(r_onbasal_B1 * d_Aprime1_B1);


  //update propensity for Burst1_on_orig = Burst1_off_orig for allele1
  propensities[20] = Burst1_on_orig_allele1*(Burst1_is_mutated_allele1*r_off_Anonsense1 + (1-Burst1_is_mutated_allele1)*r_off_A1);
  //update propensity for Burst1_on_orig = Burst1_off_orig for allele2
  propensities[21] = Burst1_on_orig_allele2*(Burst1_is_mutated_allele2*r_off_Anonsense1 + (1-Burst1_is_mutated_allele2)*r_off_A1);
  //update propensity for Burst1_on_para = Burst1_off_para for allele1
  propensities[22] = Burst1_on_para_allele1*r_off_Aprime1;
  //update propensity for Burst1_on_para = Burst1_off_para for allele2
  propensities[23] = Burst1_on_para_allele2*r_off_Aprime1;
  //update propensity for Burst1_on_targ = Burst1_offorig_targ for allele1
  propensities[24] = Burst1_on_targ_allele1*(r_offorig_B1 + r_addon_byA1_B1*(pow(A1,n_A1 )/(pow(k_A1 ,n_A1 )+pow(A1,n_A1 ))));
  //update propensity for Burst1_on_targ = Burst1_offpara_targ for allele1
  propensities[25] = Burst1_on_targ_allele1*(r_offpara_B1 + r_addon_byAprime1_B1*(pow(Aprime1,n_Aprime1 )/(pow(k_Aprime1 ,n_Aprime1 )+pow(Aprime1,n_Aprime1 ))));
  //update propensity for Burst1_on_targ = Burst1_offorig_targ for allele2
  propensities[26] = Burst1_on_targ_allele2*(r_offorig_B1 + r_addon_byA1_B1*(pow(A1,n_A1 )/(pow(k_A1 ,n_A1 )+pow(A1,n_A1 ))));
  //update propensity for Burst1_on_targ = Burst1_offpara_targ for allele2
  propensities[27] = Burst1_on_targ_allele2*(r_offpara_B1 + r_addon_byAprime1_B1*(pow(Aprime1,n_Aprime1 )/(pow(k_Aprime1 ,n_Aprime1 )+pow(Aprime1,n_Aprime1 ))));
  ...
  // Burst1_offorig_targ = Burst1_on_targ for allele1

  Burst1_offorig_targ_allele1 = 0;
  ...
  // Burst1_offpara_targ = Burst1_on_targ for allele1
  ...
  // Burst1_offorig_targ = Burst1_on_targ for allele2

  Burst1_offorig_targ_allele2 = 0;
  ...
  // Burst1_offpara_targ = Burst1_on_targ for allele2
  ...
  // rxn: Burst1_on_targ = Burst1_offorig_targ for allele1
  ...
  // rxn: Burst1_on_targ = Burst1_offpara_targ for allele1

  Burst1_offorig_targ_allele1 = 0;
  Burst1_offpara_targ_allele1 = 1;
  Burst1_on_targ_allele1 = 0;
  ...
  // rxn: Burst1_on_targ = Burst1_offorig_targ for allele2
  ...
  // rxn: Burst1_on_targ = Burst1_offpara_targ for allele2

  Burst1_offorig_targ_allele2 = 0;
  Burst1_offpara_targ_allele2 = 1;
  Burst1_on_targ_allele2 = 0;
